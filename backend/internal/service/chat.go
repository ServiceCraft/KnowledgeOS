...
func buildSystemPrompt(settings *domain.BotSettings, sources []domain.ChatSource, toolDefs []llm.Tool, isFirstReply bool) string {
	...
	b.WriteString("- Задавай по одному уточняющему вопросу за раз — самый важный для следующего шага. НЕ вываливай список из нескольких вопросов сразу: это живой диалог, а не анкета. Задал вопрос — дождись ответа и только потом задавай следующий.\n")
